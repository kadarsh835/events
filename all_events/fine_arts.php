<div class="content">
    <header class="codrops-header">
        ...
        <h1 class="codrops-header__title">FINE ARTS EVENTS</h1>
...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Wall Graffiti')" data-title="Register"></a>
            </div>
    ...
    <div class="overlay__item" id="preview-2">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('On the Spot')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-3">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Face Painting')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    ...
    <div class="overlay__item" id="preview-5">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('3 Harmony')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-6">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Poster Designing')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-7">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/costume_designing.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">5k</span></h3>
            <h4 class="box__text"><span class="box__text-inner">Costume Designing</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Costume Designing')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
