...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Wall Graffiti" data-title="Register"></a>
            </div>
    ...
    <div class="overlay__item" id="preview-2">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=On the Spot" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-3">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Face Painting" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    ...
    <div class="overlay__item" id="preview-5">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=3 Harmony" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-6">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Poster Designing" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-7">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Costume Designing" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
