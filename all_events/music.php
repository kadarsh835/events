...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/solo_singing_indian.jpg" alt="Some image" />
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Solo Singing(Indian)')" data-title="Register"></a>
            </div>
    ...
    <div class="overlay__item" id="preview-2">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/solo_singing_western.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">10K</span></h3>
            <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">Solo Singing(Western)</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Solo Singing(Western)')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-3">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/solo_instrumental.jpg" alt="Some image" />
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Solo Instrumental')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-4">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/war_of_bands.jpg" alt="Some image" />
            <h3 class="box__title box__title--bottom"><span class="box__title-inner">5k</span></h3>
            <h4 class="box__text"><span class="box__text-inner box__text-inner--rotated2">War of Bands</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('War of Bands')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-5">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/pair_on_stage.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">4k</span></h3>
            <h4 class="box__text box__text--bottom"><span class="box__text-inner">Pair on Stage</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Pair on Stage')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-6">
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="#" onclick="function_event('Capriccio')" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
