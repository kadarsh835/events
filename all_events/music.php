...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/saaz.jpg" alt="Some image" />
    ...
    <div class="overlay__item" id="preview-2">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/adagio.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">0K</span></h3>
            <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">ADAGIO(SOLO Western)</span></h4>
        </div>
        <div class="overlay__content">
