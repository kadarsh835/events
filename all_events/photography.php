<div class="content">
    <header class="codrops-header">
        ...
        <h1 class="codrops-header__title">PHOTOGRAPHY EVENTS</h1>
    ...
    <div class="grid">
        <a class="grid__item" href="#preview-1">
            <div class="box">
                ...
                <img class="box__img" src="img/pixelerator.jpg" alt="Some image" />
                <h3 class="box__title"><span class="box__title-inner" data-hover="5K">5K</span></h3>
                <h4 class="box__text"><span class="box__text-inner">Pixelerator</span></h4>
        ...
        <a class="grid__item" href="#preview-2">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/pic_of_the_day.jpg" alt="Some image" />
                <h3 class="box__title"><span class="box__title-inner" data-hover="10K">10K</span></h3>
                <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">Pic of the Day</span></h4>
            </div>
        </a>
        <a class="grid__item" href="#preview-3">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/trailer_making.jpg" alt="Some image" />
                <h3 class="box__title box__title--straight box__title--left"><span class="box__title-inner" data-hover="10k">10k</span></h3>
                <h4 class="box__text box__text--bottom box__text--right"><span class="box__text-inner box__text-inner--rotated3">Trailer Making</span></h4>
        ...
        <a class="grid__item" href="#preview-4">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/shutter_up.jpg" alt="Some image" />
                <h3 class="box__title box__title--bottom"><span class="box__title-inner" data-hover="5k">5k</span></h3>
                <h4 class="box__text"><span class="box__text-inner box__text-inner--rotated2">Shutter Up</span></h4>
        ...
        <a class="grid__item" href="#preview-5">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/directors_cut.jpg" alt="Some image" />
                <h3 class="box__title"><span class="box__title-inner" data-hover="4k">4k</span></h3>
                <h4 class="box__text box__text--bottom"><span class="box__text-inner">Director's Cut</span></h4>
            </div>
        </a>
        <a class="grid__item" href="#preview-6">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/ad_making.jpg" alt="Some image" />
                <h3 class="box__title box__title--straight box__title--bottom"><span class="box__title-inner" data-hover="Red">9k</span></h3>
                <h4 class="box__text box__title--bottom"><span class="box__text-inner box__text-inner--rotated1">Ad Making</span></h4>
            </div>
        </a>
        <a class="grid__item" href="#preview-7">
            <div class="box">
                <div class="box__shadow"></div>
                <img class="box__img" src="img/story_teller.jpg" alt="Some image" />
                <h3 class="box__title"><span class="box__title-inner" data-hover="5k">5k</span></h3>
                <h4 class="box__text"><span class="box__text-inner">Story Teller</span></h4>
...
<div class="overlay">
    ...
    <div class="overlay__item" id="preview-1">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Pixelerator.jpg" alt="Some image" />
        ...
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Pixelerator" data-title="Register"></a>
            </div>
    ...
    <div class="overlay__item" id="preview-2">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Pic of the Day.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">10K</span></h3>Pic of the Day</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
    ...
    <div class="overlay__item" id="preview-3">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Trailer Making.jpg" alt="Some image" />
    ...
    <div class="overlay__item" id="preview-4">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Shutter Up.jpg" alt="Some image" />
    ...
    <div class="overlay__item" id="preview-5">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Director's Cut.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">4k</span></h3>
            <h4 class="box__text box__text--bottom"><span class="box__text-inner">Director's Cut</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Director's Cut" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-6">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Ad Making.jpg" alt="Some image" />
            <h3 class="box__title box__title--straight box__title--bottom"><span class="box__title-inner">9k</span></h3>
            <h4 class="box__text box__title--bottom"><span class="box__text-inner box__text-inner--rotated1">Ad Making</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Ad Making" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
    <div class="overlay__item" id="preview-7">
        <div class="box">
            <div class="box__shadow"></div>
            <img class="box__img box__img--original" src="img/original/Story Teller.jpg" alt="Some image" />
            <h3 class="box__title"><span class="box__title-inner">5k</span></h3>
            <h4 class="box__text"><span class="box__text-inner">Story Teller</span></h4>
        </div>
        <div class="overlay__content">
            <div class="myBtn">
                <a href="register.php?event=Story Teller" data-title="Register"></a>
            </div>
            <p> It's time the tale were told of how you took a child and you made him old.</p>
        </div>
    </div>
